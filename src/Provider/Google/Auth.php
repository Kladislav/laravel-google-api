...
namespace Kladislav\LaravelGoogleApi\Provider\Google;

use Kladislav\LaravelGoogleApi\AbstractProvider;
use Kladislav\LaravelGoogleApi\Exceptions\AuthorizationException;
use Kladislav\LaravelGoogleApi\Exceptions\InvalidStateException;
